package com.zmeev.concurrency.communication;
...
public class MainApplication {
    private static final String INPUT_FILE = "src/main/out/matrices.txt";
    private static final String OUTPUT_FILE = "src/main/out/matrices_results.txt";
